...
/**
 * Configuration class intended to store all authentication and authorization
 * settings.
 */
@Slf4j
@Configuration
public class SecurityConfig {
  ...
  /**
   * This is meant to be executed at the start of the application so that the authorization
   * token is displayed in the console.
   */
  @Bean
  @Order(2)
